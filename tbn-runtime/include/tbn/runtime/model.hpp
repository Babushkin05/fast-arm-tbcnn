...
#include "../tbn.hpp" // This provides the public API functions that use TBNModel
...
// Forward declarations for the main header
class TBNModel {
public:
    class Session;
    Session create_session();
...
// Cleanup - remove duplicate definitions
#undef load_model
#undef load_model_from_buffer
#undef get_version

// Include standard libraries for the rest of the file
#include <cmath>
#include <algorithm>
#include <functional>
#include <stdexcept>
...
// Final cleanup to ensure no circular dependencies
#ifndef TBN_MODEL_HPP_NO_INCLUDES
// This file should be included by tbn.hpp, not the other way around
#endif